...
import com.lk.ecommerce.Model.Cart;
import com.lk.ecommerce.Prevalent.Prevalent;
import com.lk.ecommerce.R;
import com.lk.ecommerce.ViewHolder.CartViewHolder;
            ...
            public void onClick(View v) {
               // txtTotalAmount.setText("Total Price = $" + String.valueOf(overTotalPrice));
                if(overTotalPrice==0){
                    ...
                    Toast.makeText(CartActivity.this, "Add some items to proceed to shippment...", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull Cart model) {
                ...
                txtTotalAmount.setText("Total Price = $" + String.valueOf(overTotalPrice));////total amount eka cart icon eka click karama pennanawa
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (which == 1) {  //admin ge side eke admin view cart ekenuth , user ge cart eke thibba items remove krna code eka
