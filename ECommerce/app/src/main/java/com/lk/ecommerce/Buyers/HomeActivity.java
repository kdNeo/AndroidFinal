...
import com.lk.ecommerce.Admin.AdminMaintainProductsActivity;
import com.lk.ecommerce.Model.Products;
import com.lk.ecommerce.Prevalent.Prevalent;
import com.lk.ecommerce.R;
import com.lk.ecommerce.Sellers.ContactUstoSeller;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cart) {
            ...
            if (!type.equals("Admin")) {
                ...
                Intent intent = new Intent(HomeActivity.this, ContactUstoSeller.class);
                startActivity(intent);
